...
var incompleteTaskHolder = document.getElementById("activ"); //ul of #activ
...
var taskCompleted = function () {
  ...
  listItem.classList.remove("activ__item");
...
var taskIncomplete = function () {
  ...
  //Append the task list item to the #activ.
  var listItem = this.parentNode;
  incompleteTaskHolder.appendChild(listItem);
  bindTaskEvents(listItem, taskCompleted);

  listItem.classList.add("activ__item");
